...
export const BASE_URL = 'http://localhost:5000/api/';//'http://localhost:5000/api/'; //  'http://172.27.160.34:5000/api/';
export const WS_BASE_URL = 'ws://localhost:5000/ws';//'ws://localhost:5000/ws';  // 'ws://172.27.160.34:5000/ws';
